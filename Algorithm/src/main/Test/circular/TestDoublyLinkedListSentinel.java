...
import LinkedList.DoublyLinkedListSentinel;
import LinkedList.NDoublyLinkedListSentinel;
...
class TestDoublyLinkedListSentinel {
    ...
    public void addFirst() {
        NDoublyLinkedListSentinel list = new NDoublyLinkedListSentinel();
        list.addFirst(1);
        list.addFirst(2);
        list.addFirst(3);
        list.addFirst(4);
    ...
    public void removeFirst() {
        NDoublyLinkedListSentinel list = getList();
        list.removeFirst();
    ...
    private NDoublyLinkedListSentinel getList() {
        NDoublyLinkedListSentinel list = new NDoublyLinkedListSentinel();
        list.addLast(1);
        list.addLast(2);
        list.addLast(3);
